...
$email   = $_POST["email"];
$email2 = $_POST["email2"];
$touristspot = implode(",", $_POST["touristspot"]); 
//$touristspot = $_POST["touristspot"];
...
//３．データ登録SQL作成
$stmt = $pdo->prepare("INSERT INTO trip(id, lastname, firstname, sex, age, college, email, email2, touristspot, indate)VALUES(NULL, :a1, :a2, :a3, :a4, :a5, :a6, :a7, :a8, sysdate())");
...
$stmt->bindValue(':a8', $touristspot, PDO::PARAM_STR);
$status = $stmt->execute();
...
if (isset($_POST['lastname'])){
    ...
    if ($name===""){
      ...
      $isError = true;
        ...
        echo'<a href="trip.php"><input type="submit" value="戻る"><br><br></a>';
    }
  } else {
    // 未設定のときエラー
    $isError = true;
