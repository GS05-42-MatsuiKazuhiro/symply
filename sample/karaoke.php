...
<body>
    ...
    <!-- Main[Start] -->
<form method="post" action="insert_karaoke.php">
  <div class="jumbotron">
    <dl>
     <dt><label>姓</label></dt>
   ...
   　　　<option>18歳</option>
     ...
     <dt><label>ジャンル（複数選択可）</label></dt>
        <dd>
        <input type="checkbox" value="1" name="genre[]" checked> J-POP<br>
        <input type="checkbox" value="2" name="genre[]" checked> 洋楽<br>
        <input type="checkbox" value="3" name="genre[]" checked> アニソン
        </dd>
        
        <dt><label>カラオケをする場所</label></dt>
