...
//３．データ登録SQL作成
$stmt = $pdo->prepare("INSERT INTO karaoke(id, lastname, firstname, sex, age, college, email, email2, genre, place, indate )VALUES(NULL, :a1, :a2, :a3, :a4, :a5, :a6, :a7, :a8, :a9, sysdate())");
...
$stmt->bindValue(':a8', $genre, PDO::PARAM_STR);
...
if (isset($_POST['lastname'])){
    ...
    if ($name===""){
      ...
      $isError = true;
        ...
        echo'<a href="karaoke.php"><input type="submit" value="戻る"><br><br></a>';
    }
  } else {
    // 未設定のときエラー
    $isError = true;
