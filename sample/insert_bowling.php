...
$yourscore = implode(",", $_POST["yourscore"]); 
$place  = $_POST["place"];
...
//３．データ登録SQL作成
$stmt = $pdo->prepare("INSERT INTO bowling(id, lastname, firstname, sex, age, college, email, email2, myscore, yourscore, place, indate )VALUES(NULL, :a1, :a2, :a3, :a4, :a5, :a6, :a7, :a8, :a9, :a10, sysdate())");
...
$stmt->bindValue(':a8', $myscore, PDO::PARAM_INT);
$stmt->bindValue(':a9', $yourscore, PDO::PARAM_STR);
...
if (isset($_POST['lastname'])){
    ...
    if ($name===""){
      ...
      $isError = true;
        ...
        echo'<a href="bowling.php"><input type="submit" value="戻る"><br><br></a>';
    }
  } else {
    // 未設定のときエラー
    $isError = true;
