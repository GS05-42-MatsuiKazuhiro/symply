...
//３．データ登録SQL作成
$stmt = $pdo->prepare("INSERT INTO kansen_soccer(id, lastname, firstname, sex, age, college, email, email2, myclub, desire, place, indate)VALUES(NULL, :a1, :a2, :a3, :a4, :a5, :a6, :a7, :a8, :a9, :a10, sysdate())");
...
if (isset($_POST['lastname'])){
    ...
    if ($name===""){
      ...
      $isError = true;
        ...
        echo'<a href="kansen_soccer.php"><input type="submit" value="戻る"><br><br></a>';
    }
  } else {
    // 未設定のときエラー
    $isError = true;
