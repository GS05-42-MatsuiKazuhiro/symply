...
<form method="post" action="insert_movie.php">
  <div class="jumbotron">
   ...
   　　　<option>18歳</option>
     ...
     <dt><label>見たい映画（複数選択可）</label></dt>
        <dd>
        <input type="checkbox" value="1" name="title[]" checked> 君の名は。<br>
        <input type="checkbox" value="2" name="title[]" checked> 何者<br>
        <input type="checkbox" value="3" name="title[]" checked> デスノート Light up the NEW world<br>
        <input type="checkbox" value="4" name="title[]" checked> ジェイソン・ボーン
        </dd>
<!--
